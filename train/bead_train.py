# UNet 비드 세그멘테이션 학습 스크립트 (초기 버전, 1024 입력)
# - A.Resize로 정사각 리사이즈 (비율 유지 X), augmentation 포함
# - BCE + Dice 복합 손실, EarlyStopping, ReduceLROnPlateau
# - Train/Val/Test 분할 (70/15/15), 학습 후 Test IoU/Dice 평가
# - 결과: modelresult/{timestamp}/unet_best.pth, loss_curve.png
# ※ IMAGE_DIR, MASK_DIR 변수가 정의되지 않은 상태 — bead_train_end.py가 개선 버전
