# Labelme JSON 라벨링 파일 → 바이너리 마스크 PNG 변환 스크립트
# - "end" 라벨의 polygon을 흰색(255)으로 채운 마스크 이미지 생성
# - 학습용 마스크 데이터 준비에 사용
...
JSON_DIR = "/home/ho/Downloads/shinybead/shiny"
OUT_DIR  = "/home/ho/Downloads/shinybead/shiny_mask"   # 저장 폴더
